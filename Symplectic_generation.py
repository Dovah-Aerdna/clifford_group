...
def int2bits(i,n): # converts integer i to an length n array of bits
    ...
    #print("i=", i, "n=",n) # debug
    for j in range(0,n):
        output[j]=i&1 # original
        # output[j]=i%2   # modified
        i>>=1
    return output
########### end int2bits ##########################
...
#
    ...
    # QUI PROBLEMA! IL PRIMO ARGOMENTO NON E' INTERO (i non è intero)
...
def bits2int(b,nn): # converts an nn-bit string b to an
